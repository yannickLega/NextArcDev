    ...
    <Grid container direction="column">
      <Head>
        ...
        <meta
          name="description"
          key="description"
          content="Completely custom desidned and built from scratch to be blazing fast. Optimized code, server-side rendering, and perfect responsive design | 99% PageSpeed Score"
        />
        <meta
          property="og:title"
        ...
        <Grid item>
          <Grid container direction="column">
            ...
            <Grid item>
              <img
                src="/assets/seo.svg"
                alt="website standing standing on winner's podium"
              />
            </Grid>
          </Grid>
        </Grid>
